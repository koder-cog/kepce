...
<div class="auth-form-container">
  ...
  <div id="reset-message-container">
    {#if isSuccess}
      <div class="auth-success">
        Eğer bu e-posta adresi sistemimizde kayıtlıysa, şifre sıfırlama talimatlarını gönderdik. Lütfen kutunu (ve spam klasörünü) kontrol et.
      </div>
    {/if}
  ...
  {#if !isSuccess}
    <form class="auth-form" onsubmit={handleSubmit}>
      <div class="form-group form-group--floating" class:form-group--error={formError} data-error={errorMsg}>
        <input type="email" id="reset-email" bind:value={email} required autocomplete="email" placeholder=" ">
        <label class="form-label" for="reset-email">E-postam şuydu<span class="form-required-mark">*</span></label>
      </div>
