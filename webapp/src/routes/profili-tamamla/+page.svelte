...
<script>
  ...
  let cityOptions = $derived([
    ...
    ...cities.map(c => ({ value: c.slug, label: c.name })).sort((a, b) => a.label.localeCompare(b.label, 'tr'))
  ]);
...
{#if !isInitializing}
  {#if !isNewOAuth}
    <div class="empty-state-container">
      <EmptyState statusCode={403} title={'403: Elleşme Ayarlarla'} desc={'Bu hesabın profili daha önceden oluşturulmuş. İlla bir şeyleri kurcalayacaksan efendi gibi ayarlar sayfasına geç.'}>
  ...
  {:else}
    ...
    <div class="form-footer-hint u-mb-xl u-text-sm u-weight-semibold u-color-secondary">Kepçe'ye giriş yaptın ama halledilmesi gereken bağzı şeyler var.</div>
    ...
    <div class="auth-form-container">
      <form class="auth-form" onsubmit={handleSubmit}>
        ...
        <div class="form-group">
          ...
          <div class="form-help">
            Eğer bulunulan şehir için menü yoksa varsayılan olarak seçtiğin şehir gösterilir.
          </div>
        </div>
          ...
          <div class="c-boxed-list">
            <div class="c-list-row">
              <div class="c-list-row__content">
                ...
                <span class="c-list-row__desc">Glutensiz seçenekleri ve çapraz bulaşma uyarılarını göster.</span>
              </div>
              <div class="c-list-row__control">
                <div class="c-switch"><input type="checkbox" bind:checked={isCeliac} id="profile-diet" class="c-input-hidden"><div class="c-switch__handle"></div></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="legal-consents" class:form-group--error={legalError} data-error={errorMsg}>
            <label class="form-switch-row">
              ...
              <span class="form-switch-row__text">
                <a href="/gizlilik-politikasi" target="_blank">Gizlilik Politikası</a>nı (KVKK Aydınlatma Metni) okudum.
              </span>
            </label>
            <label class="form-switch-row">
              ...
              <div class="c-switch"><div class="c-switch__handle"></div></div>
              <span class="form-switch-row__text">
                <a href="/kullanim-kosullari" target="_blank">Kullanım Koşulları</a>nı kabul ediyorum.
              </span>
            </label>
            <label class="form-switch-row">
            ...
            <label class="form-switch-row">
              ...
              <div class="c-switch"><div class="c-switch__handle"></div></div>
              <span class="form-switch-row__text">
                Kişisel verilerimin, KVKK Madde 9 uyarınca sunucuların bulunduğu yurt dışına (Marsilya/Fransa) aktarılmasına açık rıza veriyorum.
              </span>
            </label>
          </div>

          <button type="submit" class="btn btn--primary btn--large auth-submit u-mt-lg" disabled={isLoading} class:is-loading={isLoading}>
            Kayıt ol işte böyle
          </button>
        </div>
      </form>
