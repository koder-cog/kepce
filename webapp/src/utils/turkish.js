...
export const CITY_ALIASES = {
  // Halk ağzı / yaygın kısaltmalar ve büyük ilçeler
  ...
  aybu: "ankara",
  aybü: "ankara",
  yildirimbeyazit: "ankara",
  yıldırımbeyazıt: "ankara",
  asbu: "ankara",
  asbü: "ankara",
  ostim: "ankara",
  ostimteknik: "ankara",
  ...
  yildiz: "istanbul",
  yıldız: "istanbul",
  yildizteknik: "istanbul",
  yıldızteknik: "istanbul",
  marmara: "istanbul",
  iu: "istanbul",
  iü: "istanbul",
  istanbuluni: "istanbul",
  istanbulüniversitesi: "istanbul",
  iuc: "istanbul",
  iüc: "istanbul",
  cerrahpasa: "istanbul",
  cerrahpaşa: "istanbul",
  ...
  fbu: "istanbul",
  fbü: "istanbul",
  fenerbahceuni: "istanbul",
  fenerbahçeüni: "istanbul",
  gedik: "istanbul",
  gedikuni: "istanbul",
  ibnhaldun: "istanbul",
  sbu: "istanbul",
  ...
  alku: "antalya",
  alkü: "antalya",
  alaaddinkeykubat: "antalya",
  ahep: "antalya",
  antalyabilim: "antalya",
  sdu: "isparta",
  sdü: "isparta",
  suleymandemirel: "isparta",
  süleymandemirel: "isparta",
  isubu: "isparta",
  isubü: "isparta",
  maku: "burdur",
  makü: "burdur",
  mehmetakifersoy: "burdur",
  mehmetakif: "burdur",
  ...
  estu: "eskisehir",
  estü: "eskisehir",
  eskisehirteknik: "eskisehir",
  selcuk: "konya",
  selçuk: "konya",
  neu: "konya",
  neü: "konya",
  necmettinerbakan: "konya",
  ktun: "konya",
  ktün: "konya",
  konyateknik: "konya",
  karatay: "konya",
  ...
  banu: "balikesir",
  banü: "balikesir",
  onyedieylul: "balikesir",
  onyedieylül: "balikesir",
  comu: "canakkale",
  çomü: "canakkale",
  onsekizmart: "canakkale",

  // --- KOCAELİ & SAKARYA & DÜZCE & BOLU & BİLECİK & YALOVA ---
  kou: "kocaeli",
  koü: "kocaeli",
  gtu: "kocaeli",
  gtü: "kocaeli",
  ...
  // --- EGE (AYDIN, DENİZLİ, MANİSA, MUĞLA, UŞAK, KÜTAHYA, AFYON) ---
  adu: "aydin",
  adü: "aydin",
  adnanmenderes: "aydin",
  pau: "denizli",
  ...
  rteu: "rize",
  rteü: "rize",
  receptayyiperdogan: "rize",
  coruh: "artvin",
  çoruh: "artvin",
  beun: "zonguldak",
  beün: "zonguldak",
  bulentecevit: "zonguldak",
  bülentecevit: "zonguldak",
  karaelmas: "zonguldak",
  kbu: "karabuk",
  kbü: "karabuk",
  snu: "sinop",
  ...
  ohu: "nigde",
  ohü: "nigde",
  omerhalisdemir: "nigde",
  ömerhalisdemir: "nigde",
  asu: "aksaray",
  asü: "aksaray",
  ahievran: "kirsehir",
  kku: "kirikkale",
  ...
  etu: "erzurum",
  etü: "erzurum",
  erzurumteknik: "erzurum",
  ebyu: "erzincan",
  ebyü: "erzincan",
  binaliyildirim: "erzincan",
  binaliyıldırım: "erzincan",
  inonu: "malatya",
  inönü: "malatya",
  turgutozal: "malatya",
  turgutözal: "malatya",
  ...
  // --- GÜNEYDOĞU ANADOLU & AKDENİZ DOĞU ---
  gaun: "gaziantep",
  gaün: "gaziantep",
  gibtu: "gaziantep",
  gibtü: "gaziantep",
  ...
  mustafakemal: "hatay",
  iste: "hatay",
  iskenderunteknik: "hatay",
  ksu: "kahramanmaras",
  ksü: "kahramanmaras",
  sutcuimam: "kahramanmaras",
  sütçüimam: "kahramanmaras",
  artuklu: "mardin",
  korkutata: "osmaniye",
  oku: "osmaniye",
  okü: "osmaniye",
...
export function normalizeTurkishText(str) {
  ...
  return str
    ...
    .replace(/[çğıöşü]/g, (char) => TURKISH_CHAR_MAP[char])
    .replace(/[''’`]/g, "")
    .replace(/[^a-z0-9\s]/g, " ")
    .replace(/\s+/g, " ")
    .trim();
