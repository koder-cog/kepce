...
use super::sea_orm_active_enums::AccountStatusEnum;
...
pub struct Model {
    ...
    pub notif_replies: bool,
    pub notif_interactions: bool,
...
pub enum Relation {
    ...
    Comments,
    #[sea_orm(has_many = "super::contact_messages::Entity")]
    ContactMessages,
    #[sea_orm(has_many = "super::dish_votes::Entity")]
    DishVotes,
    #[sea_orm(has_many = "super::menu_submissions::Entity")]
    MenuSubmissions,
    #[sea_orm(has_many = "super::menu_votes::Entity")]
    MenuVotes,
    ...
    UserSessions,
    #[sea_orm(has_many = "super::user_warnings::Entity")]
    UserWarnings,
    #[sea_orm(has_many = "super::vote_reactions::Entity")]
    VoteReactions,
}
...
impl Related<super::menu_submissions::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::MenuSubmissions.def()
    }
}

impl Related<super::menu_votes::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::MenuVotes.def()
    }
}
...
impl Related<super::user_warnings::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::UserWarnings.def()
    }
}

impl Related<super::vote_reactions::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::VoteReactions.def()
    }
}

impl Related<super::badges::Entity> for Entity {
    fn to() -> RelationDef {
        super::user_badges::Relation::Badges.def()
    }
    fn via() -> Option<RelationDef> {
        Some(super::user_badges::Relation::Users.def().rev())
    }
}
