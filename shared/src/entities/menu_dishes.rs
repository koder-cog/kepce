...
pub struct Model {
    #[sea_orm(primary_key)]
    pub id: i32,
    #[sea_orm(unique_key = "menu_dishes_menu_id_dish_alias_id_package_name_key")]
    pub menu_id: i32,
    #[sea_orm(unique_key = "menu_dishes_menu_id_dish_alias_id_package_name_key")]
    pub dish_alias_id: i32,
    pub order_index: i32,
...
pub enum Relation {
    #[sea_orm(
        belongs_to = "super::dish_aliases::Entity",
        from = "Column::DishAliasId",
        to = "super::dish_aliases::Column::Id",
        on_update = "NoAction",
        on_delete = "Restrict"
    )]
    DishAliases,
